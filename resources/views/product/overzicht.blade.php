<x-app-layout>
    ...
    <div>
        <div class="pt-15 mt-8 w-4/5 m-auto">
            ...
            <button id="myBtn" class="bg-yellow-400 uppercase ml-2 text-gray-100 text-xs font-extrabold py-3 px-5 rounded-3xl " data-bs-toggle="modal" data-bs-target="#exampleModal">
                Create category
            </button>
        </div>
    </div>
